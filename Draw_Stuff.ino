...
// Primeira descida para o apagador
  case 111:
    drawTo(PARKX, PARKY); //Retorna o park para o lugar certo. (REDUNDANCIA)
    lift(0);
    drawTo(70, 46);
    drawTo(ERASEMAXX, 43);
    ...
    drawTo(EPARKX, EPARKY); //Modifica o park para o apagador entrar no suporte.
    lift(2);
